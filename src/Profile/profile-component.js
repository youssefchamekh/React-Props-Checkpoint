...
export default function Profile({name,adresse,work,picture}) {
  return (
    <>
    ...
    <div id="profile" className="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
      <div className="p-4 md:p-12 text-center lg:text-left">
        ...
        <div className="pt-12 pb-8">
          <button className="bg-green-700 hover:bg-green-900 text-white font-bold py-2 px-4 rounded-full" onClick={()=>alert(name)}>
          Alert message
          </button> 
        </div>
      </div>
    ...
    {/*Img Col*/}
   <Profileimage picture={img}></Profileimage>
