...
export default function Profile({ name, adresse, work, children, sayName }) {
    ...
    <>
      <div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
        ...
        <div className="w-full lg:w-2/5">
          ...
          <img src={children} className="rounded-none lg:rounded-lg shadow-2xl hidden lg:block" />
        </div>
...
Profile.defaultProps = {
  name: "Youssef chamekh",
  adresse: "Hay Hassani Casablanca Morocco",
  work: "web developper"
}
